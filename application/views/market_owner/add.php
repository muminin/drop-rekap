    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">T Market Owner Add</h3>
            </div>
            <?php echo form_open('market_owner/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="id_market" value="<?php echo $this->input->post('id_market'); ?>" class="form-control" id="id_market" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="url_name" value="<?php echo $this->input->post('url_name'); ?>" class="form-control" id="url_name" />
						</div>
					</div>
					<div class="col-md-6">
