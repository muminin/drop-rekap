    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">T Transaction Add</h3>
            </div>
          	...
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="id_market_owner" value="<?php echo $this->input->post('id_market_owner'); ?>" class="form-control" id="id_market_owner" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="transaction_date" class="control-label">Transaction Date</label>
						<div class="form-group">
							<input type="text" name="transaction_date" value="<?php echo $this->input->post('transaction_date'); ?>" class="has-datepicker form-control" id="transaction_date" />
						</div>
					</div>
					<div class="col-md-6">
