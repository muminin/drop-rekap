    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">M Privilege Add</h3>
            </div>
            <?php echo form_open('privilege/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="const" value="<?php echo $this->input->post('const'); ?>" class="form-control" id="const" />
						</div>
					</div>
					<div class="col-md-6">
